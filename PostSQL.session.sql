...
ALTER TABLE public.job_postings_fact
ADD COLUMN created_by INT NULL,
    ADD FOREIGN KEY (created_by) REFERENCES public.users (user_id);
ALTER TABLE public.company_dim
ADD COLUMN created_by INT NULL,
    ADD FOREIGN KEY (created_by) REFERENCES public.users (user_id);
ALTER TABLE public.skills_dim
ADD COLUMN created_by INT NULL,
    ADD FOREIGN KEY (created_by) REFERENCES public.users (user_id);
ALTER TABLE public.skills_job_dim
ADD COLUMN created_by INT NULL,
    ADD FOREIGN KEY (created_by) REFERENCES public.users (user_id);

ALTER TABLE public.users DROP COLUMN is_admin;
ALTER TABLE public.users ADD COLUMN user_type VARCHAR(50) DEFAULT 'user';
